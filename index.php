...
<html lang="en">
    ...
    <body>
        ...
        <div id="homeContent" class="container-fluid">
            ...
            <div id="homeButtonDescriptions" class="container" >
                <!--<div class="row">-->
                    <div class="row">
                        <div id="whoCard" class="col-sm-3 card p-0 mx-auto border-0 homeCardSmall" style="min-width: 9rem; max-width: 18rem;">
                            <a href="who.php" class="card-body text-center homeCard rounded m-2 shadow-sm noListStyle">
                                <h5 class="card-title">WHO</h5>
                                <p class="card-text">Get to know the people involved mentioned in the scriptures.</p>
                            </a>
                        </div>

                        <div id="whatCard" class="col-sm-3 card p-0 mx-auto border-0 homeCardSmall" style="min-width: 9rem; max-width: 18rem;">
                            <a href="what.php" class="card-body text-center homeCard rounded m-2 shadow-sm">
...
<!--                    </div>
                    ...
                    <div class="row">-->
<!--<div class="w-100"></div>-->
                        <div id="whereCard" class="col-sm-3 card p-0 mx-auto border-0 homeCardSmall" style="min-width: 9rem; max-width: 18rem;">
                            <a href="where.php" class="card-body text-center homeCard rounded m-2 shadow-sm">
                                <h5 class="card-title">WHERE</h5>
                                <p class="card-text">Use modern GIS to explore the location of places mentioned in the bible.</p>
                            </a>
                        </div>

                        <div id="whenCard" class="col-sm-3 card p-0 mx-auto border-0 homeCardSmall" style="min-width: 9rem; max-width: 18rem;">
                            <a href="when.php" class="card-body text-center homeCard rounded m-2 shadow-sm">
