...
<div id="headerMain" class="container-fluid bg-light">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="gallery.php">Gallery<span class="sr-only">(current)</span></a><!-- Gallery of images and artifacts -->
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        <div id="galleryContent" class="container-fluid">
            <div class="row">
                <h2>The Last Days of Jesus Christ</h2>
                <!-- MapBox Start -->
                <div id='mapGallery' style="width: 75%; height: calc(100vh - 100px);"></div>
            </div>
